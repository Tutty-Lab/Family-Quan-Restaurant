...
describe("maxShiftHoursForWindow", () => {
  it("rechnet mit Anwesenheit inkl. Pause, nicht mit bezahlter Zeit", () => {
    // Mit der 60-min-Pause: 10h->660, 9h->600, 8h->540, 7h->480,
    // 6h->360, 5h->300, 3h->180.
    //
    // Das Fenster 12:00–22:00 sind 600 Minuten und trägt damit genau eine
    // 9-Stunden-Schicht (9 h + 60 min = 600), aber keine 10-Stunden-Schicht.
    expect(maxShiftHoursForWindow(600)).toBe(9); // 12:00–22:00
